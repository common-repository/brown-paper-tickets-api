...
Plugin URI: http://wordpress.org/extend/plugins/brown-paper-tickets-api/
	...
	{	
		...
		foreach($event_data as $event)
		{
			...
			foreach($event['dates'] as $date)
			{
				...
				if($time_raw < time()) continue; // if event is in the past, skip to next entry
